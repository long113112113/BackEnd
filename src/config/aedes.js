...
const timingSafeEqual = (a, b) => {
    // Hash both inputs to ensure they have the same length (32 bytes for SHA-256)
    // This prevents CWE-208 timing leaks while satisfying timingSafeEqual's length requirement
