...
const timingSafeEqual = (a, b) => {
    ...
    // Hash both inputs to guarantee equal length (32 bytes for SHA-256)
    // This prevents CWE-208 timing leaks while avoiding early returns
    // or unhandled length-mismatch exceptions.
